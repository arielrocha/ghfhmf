...
public class TicGUI extends JFrame {
    ...
    private void checkWin(int row, int col) {
        if (buttons[row][1].getText().equals(buttons[row][2].getText()) && buttons[row][0].getText().equals(buttons[row][1].getText())) {
            gameWon = true;
            System.out.println(buttons[row][0].getText() + " wins!!!");
        } else if (buttons[row][0].getText().equals(buttons[row][1].getText()) && buttons[row][1].getText().equals(buttons[row][2].getText())) {
            gameWon = true;
            System.out.println(buttons[row][0].getText() + " wins!!!");
        }
    }
